...
public class FlexiblePortfolioTest {
  ...
  @Test
  public void testdcaComposition() throws IOException {
    Reader in = new StringReader("2 junitdca 4 9 3");
    StringBuffer out = new StringBuffer();
    ControllerFlexible cnt = new ControllerFlexible(in, out);
    cnt.start(new PortfolioFlexible());
    String[] output = out.toString().split("\n");
    assertEquals("JPM : 6.3042326323540845", output[31]);
  }

  @Test
  public void testdcaValue() throws IOException {
    StringBuffer out = new StringBuffer();
    Reader in = new StringReader("2 junitdcatwo 3 strat 100 MDB 30 VOD 20 BAC " +
            "50 quit 2022-11-20 2022-12-25 10 5 2022-11-17 5 2022-11-27 9 3");
    ControllerFlexible cnt = new ControllerFlexible(in, out);
    cnt.start(new PortfolioFlexible());
    String[] output = out.toString().split("\n");
    assertEquals("Cost basis is: $22.72", output[140]);
    assertEquals("Cost basis is: $154.0229", output[156]);
  }

  @Test
  public void testdcaCostBasis() throws IOException {
    StringBuffer out = new StringBuffer();
    Reader in = new StringReader("2 junitdcathree 3 strat 100 NFLX 30 VOD 20 BAC 50 quit " +
            "2022-11-20 2022-12-25 10 6 2022-11-17 6 2022-11-27 9 3");
    ControllerFlexible cnt = new ControllerFlexible(in, out);
    cnt.start(new PortfolioFlexible());
    String[] output = out.toString().split("\n");
